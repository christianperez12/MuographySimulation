...
// *                                                                  *
// * This  code  implementation iss the result of  the  scientific and *
...
public:
  ...
  G4ThreeVector GetLocalConstantFieldValue();
  G4ThreeVector GetLocalFieldValue() const { return fElFieldValue; }
