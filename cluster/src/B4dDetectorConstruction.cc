  ...
  G4VPhysicalVolume* physGranite = 
    new G4PVPlacement(0,                     //no rotation
                      ...
                      fCheckOverlaps);        //overlaps checking 
                                               ...
                                               G4Material* block_mat = nist->FindOrBuildMaterial("G4_CONCRETE");
                      
                      G4Box* solidBlock =    
    new G4Box("Block",                       //its name
      2.5*cm, 0.5*cm, 5.49*mm);     //its size
      
  G4LogicalVolume* logicBlock =                         
    new G4LogicalVolume(solidBlock,          //its solid
                        block_mat,           //its material
                        "Block");            //its name
                                   
  G4VPhysicalVolume* physBlock = 
    new G4PVPlacement(0,                     //no rotation
                      G4ThreeVector(0, 0*cm, 0),       //at (0,0,0)
  ...
  SetSensitiveDetector("secondPlate",secondPlateDetector); */
   ...
   /*
	...
	new G4PVPlacement(0,                       //no rotation
					  ...
					  true);         //overlaps checking 
	//shape Spacer2
	G4ThreeVector pos4 = G4ThreeVector(-2.4*cm, 7.4*cm, 0*mm);
	...
	new G4PVPlacement(0,                       //no rotation
					  ...
					  true);         //overlaps checking 
	//shape Spacer3
	G4ThreeVector pos5 = G4ThreeVector(-2.4*cm, 2.6*cm, 0*mm);
	...
	G4ThreeVector pos6 = G4ThreeVector(2.4*cm, 2.6*cm, 0*mm);
